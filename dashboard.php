...
// 4. Get transactions based on view mode
if ($view_mode == 'daily') {
...
<head>
    ...
    <style>
        ...
        .account-status i { margin-right: 5px; color: var(--accent); }
        ...
        /* Top Row Flexbox (Card + Activity) */
        .dashboard-top-row { display: flex; gap: 30px; margin-bottom: 30px; flex-wrap: wrap; }
        
        /* The ATM Card Styling */
        .atm-card {
            background: linear-gradient(135deg, #00c6ff 0%, #0072ff 100%);
            width: 350px; height: 240px; border-radius: 20px; padding: 25px;
            color: white; position: relative; box-shadow: 0 15px 35px rgba(0,0,0,0.3);
        ...
        .activity-panel {
            flex: 1; min-width: 300px; background: var(--secondary);
        ...
        .action-card {
            ...
            text-decoration: none; color: var(--text); transition: 0.3s; cursor: pointer;
        }
        ...
        .qr-modal-card {
            ...
            border: 1px solid rgba(56, 189, 248, 0.3); border-radius: 25px;
...
<header>
    ...
    <div class="nav-user">
        ...
        ?>
        <a href="profile.php" style="display: flex; align-items: center; gap: 15px; text-decoration: none; color: white; transition: 0.2s;">
...
<div class="container">
    ...
    <!-- Quick Stats Cards with Euro Currency -->
    ...
    <div class="dashboard-top-row">
        ...
        <!-- Recent Activity Panel with Euro -->
                        ...
                        <div class="tx-details">
                            <p>
                                ...
                                <?php if (isset($tx['description'])): ?>
                                    <span class="tx-card-number"><?php echo $tx['description']; ?></span>
                                <?php endif; ?>
                            </p>
    ...
    <div>
        ...
        <div class="actions-grid">
            <a href="receive.php" class="action-card">
